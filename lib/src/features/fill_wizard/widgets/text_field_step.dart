...
/// Wires the pure [AppTextField] + [SpeechMicButton] to the wizard and
/// speech providers — ports the prototype's `type === 'text'` branch.
class TextFieldStep extends ConsumerWidget {
  const TextFieldStep({required this.entryId, required this.field, super.key});
